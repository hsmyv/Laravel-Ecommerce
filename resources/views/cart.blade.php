            ...
            <div class="col-lg-8">
                <div class="shopping__cart__table">
                    <table>
                        ...
                        <tbody>
                             <h3 style="margin-bottom:3%">{{Cart::instance('saveForLater')->count()}} item(s) saved for Later</h3>
                            @foreach(Cart::instance('saveForLater')->content() as $item)
                             <tr>
                                ...
                                <td class="cart__price">$ 30.00</td>
                                 ...
                                 <td class="cart__close"><i class="fa fa-close"></i>
                                    <form method="POST" action="{{route("cart.saveForLater.destroy", $item->rowId)}}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-outline-primary">remove</button>
                                    </form>
                                 ...
                                 <td class="cart__close"><i class="fa fa-open"></i>
                                    <form method="POST" action="{{route("cart.SaveForLater.switchToCart", $item->rowId)}}">
                                        @csrf
